...
const moneyIn = require('../../../assets/MoneyInforLoan.png');

export default function Loans({navigation}) {
  return (
    <View style={{ backgroundColor: colors.lightYellow, flex: 1 , paddingHorizontal: 20, paddingTop: 50, paddingBottom: 10, justifyContent: 'center' , alignItems: 'center' }}>
         <View style={[{ backgroundColor: colors.lightYellow , flex: 1 , width: 370  }, styles.mr , styles.center , styles.mb]}>
               <Pressable style={styles.acceptBtn} onPress={() => navigation.navigate('Loans')}>
                  <Image 
         ...
         <View style={[{ backgroundColor: colors.lightRed, flex: 2 , width: 370  }, styles.shadow, styles.curved , styles.mr , styles.center , styles.mb]}>
               <Pressable style={styles.acceptBtn} onPress={() => navigation.navigate('Loans')}>
                  <Image 
                    style={styles.cardImg} 
                    source={moneyDebt}
          ...
          <View style={[{ backgroundColor: colors.lightGreen , flex: 2, width: 370   }, styles.shadow, styles.curved , styles.mr , styles.center ]}>
               <Pressable style={styles.acceptBtn} onPress={() => navigation.navigate('Loans')}>
                  <Image 
                    style={styles.cardImg} 
                    source={moneyIn}
