...
export default function Dashboard2({navigation}) {
  return (
    <>
    <View style={[{flex: 2, backgroundColor: '#ffffff', marginHorizontal:5, }, styles.flexRow]}>
    <View style={[{ backgroundColor: colors.lighterYellow, flex: 2, paddingTop: 50, paddingBottom: 20, borderBottomLeftRadius: 20, borderBottomRightRadius: 20,}, styles.flexRow, styles.bottom,]}>
          <View style={[{ backgroundColor: colors.lighterYellow, flex: 4, paddingHorizontal: 20 }, styles.flexRow, styles.mr]}>
            <View style={[{flex: 1 }, styles.center]}>
              <Image
                style={styles.cardImg}
                source={cashBalance} />
            </View>
            <View style={[{ backgroundColor: colors.lighterYellow, flex: 3 }, styles.center]}>
              <Text style={styles.cashBalance}>2,200</Text>
            </View>
            <View style={[{ backgroundColor: colors.lighterYellow, flex: 1 ,paddingTop:20},]}>
              <Text>L$</Text>
            </View>
          </View>
          <View style={[{ backgroundColor: colors.lighterYellow, flex: 2 }, styles.mr, styles.center]}>
    ...
    <View style={{ backgroundColor: "#ffffff", flex: 8, paddingHorizontal: 20,paddingTop: 15, paddingBottom: 10, }}>
        ...
        <View style={[{ flex: 1, }, styles.flexRow, styles.mb]}>
          <Pressable style={{ flex: 1 }} onPress={() => navigation.navigate('Call')}>
          ...
          <Pressable style={{ flex: 1 }} onPress={() => navigation.navigate('Learn')}>
